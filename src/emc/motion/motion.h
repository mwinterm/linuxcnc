...
*/
	...
	int distance_coded_n;  /* nominal increment of index-track of glasscale */
	int distance_coded_os;  /* oversampling of glasscale signal period i.e. interpolaton factor times four if quadrature is on */
	int distance_coded_pw;  /* puls width of the index pulse after interpolation, typically 2 */
	double encoder_scale;  /* scale factor to convert signal pulses from the encoder to physical distance */
...
#define HOME_DISTANCE_CODED         256
...
*/
	...
	double motor_pos_raw_fb;	/* position feedback, without comp */
